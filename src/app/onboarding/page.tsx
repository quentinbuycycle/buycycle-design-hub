    ...
    <>
      ...
      <section className={styles.nextStepsSection}>
        <div className={styles.container}>
          ...
          <p className={styles.sectionSubtitle}>
            Setup complete? Here&apos;s where to go next.
          </p>
          <div className={styles.nextStepsGrid}>
            <Link href="/onboarding/how-to-use" className={styles.nextStepCard}>
              ...
              <h3>How to Use</h3>
              <p>Learn the workflow — from problem to polished prototype in one session.</p>
            </Link>
            <Link href="/onboarding/downloads" className={styles.nextStepCard}>
              <div className={styles.nextStepIcon}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <h3>Downloads</h3>
              <p>Get the latest design system files and custom commands.</p>
            </Link>
          </div>
        </div>
      </section>
